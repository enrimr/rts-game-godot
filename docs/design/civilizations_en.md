...
| **Bonuses** | Age advance cost ×0.85 · Cavalry HP ×1.15 · Farms built ×1.20 faster |
...
| **Bonuses** | Swordsman HP ×1.15 · Defensive volleys (towers, garrisoned TC) reach ×1.10 further · Free Blacksmith technology per age advance |
| **Restrictions** | None |
...
| **Bonuses** | Coastal vision ×1.50 (units and buildings within 400 px of a shore) · Ship attack speed ×1.20 · Harder to spot in Sea Fog (found at 90 px instead of 180 px) · Amphibious Tidecaller: wades shallow water at full speed and swims open ocean at ×0.60 (`deep_water_speed`) |
