...
| **Bonificadores** | Coste avance de edad ×0.85 · HP caballería ×1.15 · Granjas construidas ×1.20 más rápido |
...
| **Bonificadores** | HP espadachín ×1.15 · Las andanadas defensivas (torres, CU guarnecido) alcanzan ×1.10 más lejos · Tecnología gratis en Herrería por avance de edad |
