...
- **Táctica**: Ofensiva - elimina objetivos prioritarios (héroes enemigos, unidades de asedio)
...
**Stats base**: Caballería pesada (infantería con montura visual)
- HP: 320
- Attack: 22
- Speed: 95
...
**Héroe masculino existente**: Francis Drake (Plunder - bonus de oro por bajas)

**Habilidad**: **"Abordaje" (Boarding Action)**
- **Tipo**: Dash + aturdimiento
...
- **Táctica**: Iniciadora - rompe formaciones enemigas, interrumpe el asedio
- **Lore**: Grace O'Malley era una pirata irlandesa legendaria que rivalizó con Drake

**Stats base**: Infantería con bonus naval
- HP: 260
- Attack: 18
- Speed: 105
...
- **Tipo**: Invocación + buff
- **Efecto**: Invoca instantáneamente 3 Milicias temporales en su posición durante 40 segundos. Estas Milicias tienen +20% HP y ataque. Cuando expiran o mueren, no cuentan como bajas para el jugador
...
**Stats base**: Soporte (infantería con menos daño pero más HP)
- HP: 300
- Attack: 12
- Speed: 90
...
- **Efecto**: Gasta 400 de oro para convertir instantáneamente una unidad enemiga no-heroica dentro de 200px de forma **permanente**. La unidad convertida pasa a ser del jugador y mantiene toda su veteranía/mejoras. No funciona en héroes ni edificios
- **Cooldown**: 120 segundos
- **Requisito**: Requiere 400 de oro en reserva
- **Táctica**: Swing táctico - roba unidades caras (Caballeros, Trebuchets, unidades únicas)
- **Lore**: Elissa (Dido) fundó Cartago y era conocida por su astucia diplomática y comercial

**Stats base**: Infantería económica (débil en combate)
- HP: 220
- Attack: 10
- Speed: 85
- Bonus pasivo: +10% velocidad de recolección de oro para aldeanos en 400px
...
|---|---|---|---|
| Bencomo vs Dácil | Ofensa vs Defensa | Bencomo mejor en push agresivos | Dácil mejor en defensas de base |
| Doramas vs Guayarmina | Tanque vs Francotiradora | Doramas soporta línea frontal | Guayarmina es glass cannon |
| Guadarfía vs Tibiabin | Sigilo vs Control | Guadarfía gank individual | Tibiabin control de grupo |
| Béthencourt vs Catalina | Utilidad vs Duelista | Jean convierte unidades | Catalina mata héroes |
| Drake vs Grace | Economía vs Combate | Drake genera oro pasivo | Grace aporta iniciación |
| Quijote vs Dulcinea | Dive vs Invocación | Quijote divide la retaguardia | Dulcinea refuerza la línea frontal |
| Artaxerax vs Cleito | Sigilo vs Curación | Artaxerax esconde el ejército | Cleito sustenta peleas |
| Hannón vs Elissa | Pasivo vs Activo | Hannón oro gratis a largo plazo | Elissa swing táctico instantáneo |
...
### Dácil (Guanches)
**Situación**: Enemigo hace push con 10 Milicias + 2 Arqueros contra tu base.
**Respuesta**: Activa "Mountain Voice" → tus 5 Aldeanos + 3 Milicias defienden efectivamente con +2 de armadura.

### Guayarmina (Canarii)
**Situación**: Enemigo tiene un Trebuchet asediando tu Centro Urbano a 500px.
**Respuesta**: "Fate's Arrow" → mata el Trebuchet ignorando su armadura → cooldown reducido a 30s.

### Tibiabin (Mahos)
**Situación**: Enemigo hace rush de Caballeros por un paso estrecho.
**Respuesta**: "Sandstorm" en el cuello de botella → Caballeros ralentizados → tus Piqueros los alcanzan.

### Catalina (Franks)
**Situación**: Partida en modo Regicidio - necesitas matar al héroe enemigo.
**Respuesta**: "Honor Duel" al héroe enemigo → ambos hacen x2 daño → ganas el 1v1 → curas 50%.

### Grace (Britons)
**Situación**: Enemigo tiene un grupo de Arqueros detrás de Milicias.
**Respuesta**: "Boarding Action" atraviesa la línea → aturde a los Arqueros → tus Milicias los alcanzan.

### Dulcinea (Castellanos)
**Situación**: Enemigo hace rush temprano con 8 Milicias - solo tienes 2 Aldeanos y el Centro Urbano.
**Respuesta**: "Call to Arms" → 3 Milicias temporales aparecen → defiendes hasta que lleguen refuerzos.

### Cleito (Atlantes)
**Situación**: Tu ejército de 12 unidades está a 30% HP después de una batalla - el enemigo contraataca.
**Respuesta**: "Rising Tide" → cura 60 HP a todas + aumento de velocidad → te retiras mientras curas.

### Elissa (Fenicios)
**Situación**: Enemigo tiene un Caballero veterano (caro, mejorado) avanzando.
**Respuesta**: "Mercenary Pact" → gastas 400 de oro → el Caballero ahora es tuyo permanentemente.

---

## Diseño Visual (Placeholder)

Todas las heroínas usan el mismo sistema de Polygon2D que los héroes masculinos:
- **Color distintivo**: Tono ligeramente más claro o diferente matiz vs su contraparte masculina
...
- [ ] Cada habilidad funciona correctamente de forma aislada
- [ ] Habilidades no causan crashes si el héroe muere a mitad de lanzamiento
- [ ] Modo Regicidio funciona con heroínas (muerte = derrota)
...
- [ ] AI no crashea cuando el enemigo tiene heroína
...
### Fase 4: Integración de UI (1-2 horas)
...
10. Playtest de cada heroína en combate real
11. Ajustar cooldowns/números si es necesario
12. Verificar interacciones con clima/tecnologías
