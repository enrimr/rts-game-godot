...
Ocho civilizaciones distribuidas en tres capas históricas. Tu elección determina tu estilo de juego, tus bonificaciones iniciales y tu héroe único.
...
**Héroe: Artaxerax**
Una figura mitologizada, mitad almirante, mitad profeta. Su habilidad *Calima* genera un parche artificial de niebla de guerra en el mapa, ocultando tus unidades dentro durante 12 segundos. Los enemigos que entran en la nube pierden visión de tus fuerzas hasta que ya están siendo atacados.
...
**Cómo se juega:** Los Fenicios son la única civilización con acceso al Mercado desde el comienzo mismo del juego. Generan oro pasivo con barcos mercantes inactivos y pueden contratar mercenarios — unidades extraídas de los catálogos de otras civilizaciones — directamente desde el Mercado usando oro. No tanto luchan con su propio ejército como compran el de los demás.
...
**Bonificaciones pasivas:**
- Mercado disponible desde la Edad Oscura (sin requisito de tecnología)
- Los barcos mercantes generan oro pasivamente mientras están atracados
- Pueden reclutar unidades de los catálogos de otras civilizaciones en el Mercado (coste solo en oro)

**Unidad única:** *Trirreme* — galera de guerra rápida construida en el Muelle, con alto daño de embestida y velocidad superior; supera en maniobrabilidad a los barcos más pesados

**Héroe: Hannón el Navegante**
Basado en el explorador cartaginés real que documentó la costa atlántica africana en el siglo V a.C. Su habilidad *Ruta Comercial* activa un corredor generador de oro entre dos puntos del mapa durante 30 segundos — cualquier unidad amiga posicionada a lo largo de la ruta gana oro pasivamente mientras se mantiene.
...
**Cómo se juega:** Los Guanches son una civilización defensiva construida en torno al terreno volcánico. Las casillas de malpaís — la roca de lava negra y dentada que cubre gran parte del paisaje canario — ralentizan a todas las demás civilizaciones hasta hacerlas casi inútiles. Los Guanches las atraviesan sin penalización. Sus edificios de piedra son más difíciles de destruir que los de cualquier otro, y sus lanceros están disponibles desde la primera edad.

**Puntos fuertes:** Dominio del terreno volcánico, edificios duraderos, línea de lanceros fuerte desde el principio  
**Puntos débiles:** Sin caballería; sin pólvora; débiles en el mar

**Bonificaciones pasivas:**
- Sin penalización de movimiento en malpaís y casillas de lava enfriada
- Edificios de piedra +20% de puntos de vida
- Lanceros disponibles desde la Edad Oscura sin requisito de edad en el Cuartel

**Unidad única:** *Guardia del Mencey* — infantería pesada entrenada en el Castillo, alta armadura, daño adicional fuerte contra caballería. El pilar de una defensa guanche en torno al castillo.

**Héroe: Bencomo**
El verdadero Mencey de Taoro. En 1494 lideró a las fuerzas guanches hacia una victoria decisiva contra el ejército castellano en la primera batalla de Acentejo — una de las derrotas más completas jamás sufridas por una fuerza europea a manos de un ejército indígena.

Su habilidad *Ímpetu del Mencey*: durante 10 segundos, todas las unidades amigas dentro de un radio ganan +30% de velocidad de ataque. Úsala en el momento del contacto, no antes.
...
**Cómo se juega:** Los Canarii tienen la economía más potente del nivel nativo. Sus aldeanos recolectan comida más rápido, sus casas sirven como puntos de entrega, y sus arqueros son suficientemente baratos como para desplegarlos en grandes cantidades desde temprano. En terreno elevado — las casillas de risco presentes en mapas tipo Gran Canaria — su unidad única gana alcance adicional de ataque.

**Puntos fuertes:** Volumen económico, presión arquera temprana, ventaja en terreno elevado  
**Puntos débiles:** Unidades pesadas limitadas; sin fuerza naval; sufre en mapas llanos y abiertos

**Bonificaciones pasivas:**
- Los aldeanos recolectan Comida un +15% más rápido
- Las casas actúan como puntos secundarios de entrega de Comida
- Los arqueros cuestan un -20% en Comida

**Unidad única:** *Arquero del Barranco* — un arquero ligero que gana +2 de alcance de ataque cuando está sobre una casilla de risco (acantilado). Devastador en posiciones defensivas; frágil en combate abierto.

**Héroe: Doramas**
El legendario campeón de Gran Canaria. Las crónicas históricas lo describen como un personaje que solo podía ser vencido mediante traición, nunca en combate justo. Su habilidad *Desafío* obliga a una única unidad enemiga a atacarle solo a él durante 8 segundos — separándola de su grupo, sacándola de la formación, aislándola para tus arqueros.
...
**Cómo se juega:** Los Mahos construyen barato porque sustituyen la madera por piedra. Sus exploradores y caballería ligera se mueven más rápido que los equivalentes de cualquier otra civilización. En terreno de dunas no sufren penalizaciones y tienen visión extendida. Son una civilización de hostigamiento temprano — rápida, impredecible, difícil de atrapar.
...
**Bonificaciones pasivas:**
- Los edificios cuestan un -30% en Madera (construcción de piedra seca)
- Exploradores y caballería ligera +25% de velocidad de movimiento
- Línea de visión extendida en casillas de duna y desierto

**Unidad única:** *Razziador de Arenas* — caballería ligera rápida entrenada en la Caballeriza. Gana una bonificación pasiva de velocidad cuando no está en combate activo. Excelente para saquear líneas de aldeanos y escapar antes de que el enemigo pueda responder.

**Héroe: Guadarfía**
El rey maho que navegó la situación diplomática más peligrosa del archipiélago — sin aliarse completamente con ningún bando, sobreviviendo a la conquista francesa siendo demasiado útil para eliminarlo. Su habilidad *Emboscada* lo vuelve invisible en casillas de duna o desierto hasta que ataca o recibe daño. Combínalo con Razziadores de Arenas para una emboscada maho clásica.
...
**Bonificaciones pasivas:**
- Avanzar de edad cuesta un -15% en recursos
- Unidades de caballería +15% de puntos de vida
- Las granjas se construyen un 20% más rápido

**Unidad única:** *Chevalier Normand* — caballería media entrenada en el Castillo. Daño adicional contra infantería nativa. Rápida, resistente, y llega suficientemente pronto como para ser decisiva.

**Héroe: Jean de Béthencourt**
El señor normando real que plantó por primera vez una bandera europea en el archipiélago atlántico. Su habilidad *Diplomacia Forzada* convierte temporalmente a una unidad nativa cercana para que luche por ti durante 12 segundos — una referencia directa a su estrategia histórica de convertir a los líderes nativos en colaboradores.
...
**Cómo se juega:** Los Britanos tienen las mejores unidades navales del juego y los arqueros de mayor alcance de cualquier civilización. Su economía de saqueo — la bonificación de Drake — significa que el juego agresivo de matar unidades genera recursos. Premian la agresividad en el mar y a distancia.
...
**Bonificaciones pasivas:**
- Los arqueros de a pie ganan +1 de alcance de ataque por Era (desde Feudal)
- Los barcos de guerra atacan un +20% más rápido
- Las bajas cerca del héroe generan oro adicional

**Unidad única:** *Arquero de Arco Largo* — arquero de a pie con alcance excepcional, superando la mayoría de estructuras defensivas en la Era Imperial. La respuesta inglesa a todo.

**Héroe: Francis Drake**
El corsario que saqueó Las Palmas en 1595 y aun así fue repelido por la milicia de la ciudad. Su habilidad *Saqueo* dura 20 segundos — cada unidad eliminada en su radio deja oro extra para recoger. Mándalo a un combate denso, activa *Saqueo* y observa cómo cambia la economía.
...
- Torres y Castillos tienen +10% de alcance de ataque

**Unidad única:** *Conquistador* — híbrido de infantería acorazada y caballería. Daño adicional contra los tres tipos de unidades nativas. La unidad definitoria del ejército castellano en el juego tardío.

**Héroe: Don Quijote de la Mancha**
Un caballero andante de La Mancha — el corazón de Castilla, provincia de Toledo — que llega a las islas convencido de que está en una cruzada sagrada. Cervantes escribió su historia en 1605, justo después de que terminara la conquista canaria, como sátira de exactamente estos hombres: idealistas, implacables, no del todo seguros de contra qué luchan. ¿Los molinos de viento contra los que arremete? En Lanzarote y Fuerteventura — las primeras islas que pisaron los Castellanos — hay molinos históricos reales.

Su habilidad activa *Acometida del Caballero Errante* lo lanza al galope en línea recta hacia un punto objetivo, dañando todo lo que encuentra a su paso — amigo o enemigo. Apunta bien. Su habilidad pasiva *Rocinante* le otorga +15% de velocidad de movimiento en todo momento, pero sus ataques llegan con un ligero retardo, como si siempre llegara un paso detrás de la realidad.

Es el héroe con mayor daño de carga bruta. También es el más propenso a atropellar a tus propias unidades si lo usas sin cuidado.
...
| Arena / Duna | Infantería pesada -20% velocidad | Mahos inmunes |
...
El Muelle debe colocarse en tierra **adyacente al agua**. Es el único edificio desde el que se pueden entrenar unidades navales (máximo 5 en cola). El tiempo de construcción es de 45 segundos y cuesta 150 de Madera.

**Tecla de acceso rápido:** D en el menú de construcción.
...
- Construye el Muelle antes de la Edad Feudal en mapas de Islas. Una Galera de Guerra en Feudal que el rival no puede responder gana el estrecho.
- Las Barcas Pesqueras no son unidades de combate — mantén Galeras de Guerra cerca para proteger tu operación pesquera.
- Los Barcos de Transporte permitirán trasladar unidades terrestres por el estrecho cuando se implemente el sistema de guarnición.
- **Atlantes** y **Britanos** tienen bonificaciones navales y dominarán el agua abierta si no se frenan a tiempo.
